<?php
// FILE: INCLUDE_CATEGORY_HEAD.PHP
// Handle category based headings
class NameHead {
	...
	public function Head() {
		...
		while ($ShowDetailsCatname = mysqli_fetch_array($sql_exec_catname)) {
			...
			$sql_exec_component_catname = mysqli_query($connection,"SELECT category FROM data WHERE owner = $owner"); // Get the category ID from all components.
