...
class EditProj {
	public function MenuProj() {
		...
		while($row = mysqli_fetch_array($result)){
				...
				echo '" /></td>';
				echo '<td>';
				//echo '<button class="button white small" name="orderquant_increase" type="submit"><span class="fa fa-plus-square-o fa-lg"></span></button>';
				//echo '<button class="button white small" name="orderquant_decrease" type="submit"><span class="fa fa-minus-square-o fa-lg"></span></button>';
			echo '</td>';
			echo '</tr>';
		}
		...
		while($row1 = mysqli_fetch_array($result1)){
			echo '<tr>';
				...
				echo '<td>';
					...
					//echo '<button class="button white small" name="orderquant_decrease" type="submit"><span class="fa fa-minus-square fa-lg"></span></button>';
				echo '</td>';
			echo '</tr>';
